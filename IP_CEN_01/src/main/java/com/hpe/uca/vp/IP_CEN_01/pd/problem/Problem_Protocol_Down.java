 ...
 *
 */
public class Problem_Protocol_Down extends ProblemDefault implements ProblemInterface {
	
	
	public Problem_Protocol_Down() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Protocol_Down.class));
	}
	
	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Protocol_Down.class);
	@Override
