 ...
 *
 */
public class Problem_Infra_Issue extends ProblemDefault implements ProblemInterface {

	public Problem_Infra_Issue() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Infra_Issue.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Infra_Issue.class);
