 ...
 *
 */
public class Problem_Hardware_Issue extends ProblemDefault implements ProblemInterface {

	public Problem_Hardware_Issue() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Hardware_Issue.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Hardware_Issue.class);
