 ...
 *
 */
public class Problem_Node_Isolation extends ProblemDefault implements ProblemInterface {

	public Problem_Node_Isolation() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Node_Isolation.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Node_Isolation.class);
