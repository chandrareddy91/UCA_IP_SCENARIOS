 ...
 *
 */
public class Problem_Interface_Down extends ProblemDefault implements ProblemInterface {
	
	
	public Problem_Interface_Down() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Interface_Down.class));
	}
	
	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Interface_Down.class);
	@Override
