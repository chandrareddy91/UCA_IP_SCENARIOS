 ...
 *
 */
public class Problem_NNM_Issue extends ProblemDefault implements ProblemInterface {

	public Problem_NNM_Issue() {
		super();
		setLog(LoggerFactory.getLogger(Problem_NNM_Issue.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_NNM_Issue.class);
