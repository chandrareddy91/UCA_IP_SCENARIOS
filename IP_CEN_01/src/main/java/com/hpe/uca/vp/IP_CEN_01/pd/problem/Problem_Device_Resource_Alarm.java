 ...
 *
 */
public class Problem_Device_Resource_Alarm extends ProblemDefault implements ProblemInterface {

	public Problem_Device_Resource_Alarm() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Device_Resource_Alarm.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Device_Resource_Alarm.class);
