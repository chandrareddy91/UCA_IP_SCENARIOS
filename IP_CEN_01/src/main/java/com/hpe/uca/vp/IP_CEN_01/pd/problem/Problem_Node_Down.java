 ...
 *
 */
public class Problem_Node_Down extends ProblemDefault implements ProblemInterface {

	public Problem_Node_Down() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Node_Down.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Node_Down.class);
