 ...
 *
 */
public class Problem_Pop_Isolation extends ProblemDefault implements ProblemInterface {

	public Problem_Pop_Isolation() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Pop_Isolation.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Pop_Isolation.class);
