 ...
 *
 */
public class Problem_Pop_Down extends ProblemDefault implements ProblemInterface {

	public Problem_Pop_Down() {
		super();
		setLog(LoggerFactory.getLogger(Problem_Pop_Down.class));
	}

	private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(Problem_Pop_Down.class);
